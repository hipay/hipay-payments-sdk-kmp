 ...
 *
 * Runs a first-launch purge like the saved-card store does, and for the same reason: the Keychain
 * survives an uninstall, so without it a reinstall would list payments from a previous install.
 */
