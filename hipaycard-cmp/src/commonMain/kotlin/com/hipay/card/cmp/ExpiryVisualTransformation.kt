...
/**
 * Thin Compose-Multiplatform wrapper (story 11.8): the value stays raw digits (`MMYY`), the `/` +
 * caret offset maps come from the shared `formatExpiryWithOffsets` (single source, tested in the
 * core). Mirrors the Android `:hipaycard` `ExpiryVisualTransformation`.
 */
