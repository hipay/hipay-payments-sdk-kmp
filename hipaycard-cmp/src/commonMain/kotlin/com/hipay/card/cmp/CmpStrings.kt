...
private val cmpStringsEn: Map<CardEntryStringKey, String> = mapOf(
    ...
    CardEntryStringKey.A11Y_SHOW_LESS_BLOCKED to "Unavailable while the selected card is further down the list",
...
private val cmpStringsFr: Map<CardEntryStringKey, String> = mapOf(
    ...
    CardEntryStringKey.CVV_TOOLTIP to "Saisissez le CVV de votre carte.",
    ...
    CardEntryStringKey.ERROR_INVALID_CVV to "CVV invalide",
    CardEntryStringKey.ERROR_INCOMPLETE_CVV to "CVV incomplet",
    ...
    CardEntryStringKey.A11Y_SHOW_LESS_BLOCKED to "Indisponible tant que la carte sélectionnée est plus bas dans la liste",
...
private val cmpStringsIt: Map<CardEntryStringKey, String> = mapOf(
    ...
    CardEntryStringKey.LABEL_EXPIRY to "Scadenza",
    CardEntryStringKey.LABEL_CVV to "CVV",
    ...
    CardEntryStringKey.CVV_TOOLTIP to "Inserisci il CVV della tua carta.",
    ...
    CardEntryStringKey.ERROR_INVALID_CVV to "CVV non valido",
    CardEntryStringKey.ERROR_INCOMPLETE_CVV to "CVV incompleto",
    ...
    CardEntryStringKey.A11Y_SHOW_LESS_BLOCKED to "Non disponibile finché la carta selezionata è più in basso nell'elenco",
    // PROVISIONAL delete copy — see the English catalog note.
