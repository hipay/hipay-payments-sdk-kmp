...
private val cmpStringsFr: Map<CardEntryStringKey, String> = mapOf(
    ...
    CardEntryStringKey.ERROR_NETWORK_NOT_AUTHORIZED to "Ce réseau de carte n'est pas accepté",
...
private val cmpStringsIt: Map<CardEntryStringKey, String> = mapOf(
    ...
    CardEntryStringKey.ERROR_NETWORK_NOT_AUTHORIZED to "Questo circuito di carte non è accettato",
