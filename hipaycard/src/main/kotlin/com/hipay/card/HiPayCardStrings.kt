...
internal object HiPayCardStrings {
    ...
    fun resFor(key: CardEntryStringKey): Int = when (key) {
        ...
        CardEntryStringKey.ERROR_HOLDER_TOO_SHORT -> R.string.ERROR_HOLDER_TOO_SHORT
        ...
        CardEntryStringKey.LABEL_SHOW_MORE -> R.string.LABEL_SHOW_MORE
        CardEntryStringKey.LABEL_SHOW_LESS -> R.string.LABEL_SHOW_LESS
        CardEntryStringKey.A11Y_SHOW_LESS_BLOCKED -> R.string.A11Y_SHOW_LESS_BLOCKED
