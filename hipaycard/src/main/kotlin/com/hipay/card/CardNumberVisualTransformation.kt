...
/**
 * Thin Jetpack-Compose wrapper (story 11.1): the value stays raw digits, the spacing + caret
 * offset maps come from the shared `CardNetworks.formatWithOffsets` (single source, tested in the
 * core). The CMP `:hipaycard-cmp` has the same wrapper over Compose-Multiplatform.
 */
