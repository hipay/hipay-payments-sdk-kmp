        ...
        runBlocking {
            ...
            val tx = gateway.requestNewOrder(
                OrderRequest(
                    ...
                    language = "fr_FR",
                    acceptUrl = "hipaydemo://hipay-payments/gateway/orders/$orderId/accept",
                    declineUrl = "hipaydemo://hipay-payments/gateway/orders/$orderId/decline",
                    pendingUrl = "hipaydemo://hipay-payments/gateway/orders/$orderId/pending",
                    exceptionUrl = "hipaydemo://hipay-payments/gateway/orders/$orderId/exception",
                    cancelUrl = "hipaydemo://hipay-payments/gateway/orders/$orderId/cancel",
